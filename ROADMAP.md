...
401 tests backend, 663 tests frontend, 8 tests end-to-end Playwright, build sans warning.
(Chiffres relevés en exécutant les suites, pas repris de la ligne précédente : `npm test` en
comptait 566 avant le lot 2, là où cette ligne annonçait 575.)
